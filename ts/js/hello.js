...
var _a = getStock(), codex = _a.code, price2 = _a.price.price2; /*ES6,code名字必须一致，codex是别名*/
var aa = [1, 2, 3, 4];
var num1 = aa[0], num2 = aa[1]; /*数组析构*/
var num1 = aa[0], num4 = aa[3];
var num1 = aa[0], num2 = aa[1], others = aa.slice(2);
