...
//         let t = $("div[widgetname=REPORT6] > iframe > span:contains('空气质量')")

//         if (t.length > 0) {
//             $("span:contains('空气质量')").parent().attr("href", "#")
//             $("span:contains('空气质量')").css({ "color": "rgb(20,174,229)", "font-size": "15px", "font-weight": "bold" });
//             $("span:contains('空气质量')").prevAll().css({ "color": "rgb(20,174,229)", "font-size": "15px", "font-weight": "bold" });
//             clearInterval(timer);
//         }
//     }, 50)
// })

// $("#iframe1").context.getElementByTagName("span")
